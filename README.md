...
```
git clone https://github.com/{ username kamu }/HacktoberFest2019.git
...
- buat folder baru didalam folder netijen dengan username kamu dan isi folder dengan projek terbaikmu
...
- [@Sumanda97](https://githuh.com/sumanda97)
